      ...
      <section className="section-padding max-w-4xl mx-auto flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-6">
          ...
          <section className="flex flex-col gap-3">
            <h2 className="h2-style text-primary">Qu'est-ce qu'un cookie ?</h2>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="h2-style text-primary">Les cookies utilisés sur ce site</h2>
            ...
            <div className="bg-surface-mid rounded-2xl p-6 flex flex-col gap-4">
              <div className="flex flex-col gap-1">
                <h3 className="h3-style text-primary">Cookies de préférences</h3>
                <p className="text-body text-primary/60">Mémorisent vos choix de consentement aux cookies. Durée : 12 mois.</p>
              </div>
              <div className="flex flex-col gap-1">
                <h3 className="h3-style text-primary">Cookies de session</h3>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="h2-style text-primary">Cookies tiers</h2>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="h2-style text-primary">Gérer vos préférences</h2>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="h2-style text-primary">Contact</h2>
