  ...
  return (
    <nav className={`w-full flex items-center justify-between px-16 h-20 bg-primary absolute top-0 left-0 z-10`}>
      ...
      <div className="flex items-center gap-8">
        <a href="/" className={`font-body font-bold text-base text-surface hover:text-accent transition-colors ${location.pathname === '/' ? 'underline underline-offset-4' : ''}`}>Accueil</a>
        <a href="/missions" className={`font-body font-bold text-base text-surface hover:text-accent transition-colors ${location.pathname === '/missions' ? 'underline underline-offset-4' : ''}`}>Nos missions</a>
        <a href="/a-propos" className={`font-body font-bold text-base text-surface hover:text-accent transition-colors ${location.pathname === '/a-propos' ? 'underline underline-offset-4' : ''}`}>À propos</a>
