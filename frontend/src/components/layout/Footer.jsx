...
function Footer() {
  return (
    <footer>
      <div className="relative w-full h-96 bg-gray-400 flex items-end p-16">
        <div className="flex flex-col gap-4">
          <h2 className="font-heading font-bold text-surface text-5xl max-w-lg">
      ...
      <div className="bg-primary px-28 py-16 flex justify-between">
        ...
        <div className="flex flex-col gap-8 w-72">
          <div className="bg-white/40 rounded-full p-1 w-fit">
            <img src="/Logo.png" alt="Sens Solidaire" className="h-16" />
          </div>
        ...
        <div style={{ backgroundColor: '#0F2108' }} className="px-28 py-4 flex justify-between items-center border-t border-surface/15">
