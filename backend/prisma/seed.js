  ...
  const FIELD_ACTIONS = [
    {
      ...
      content: `Pour permettre aux locaux de recevoir un revenu économique tout en préservant leurs richesses naturelles, nous avons appuyé le projet de la fabrique de papier recyclé en bouse d’éléphant.La production de ce papier innovant est 100 % naturel, réalisé avec l’énergie du soleil et du vent. Les différents articles sont utilisés dans les écoles françaises dans le cadre des enseignements d’art plastique. Les déjections sont lavées à l’eau tiède pour enlever les impuretés. Puis elles sont bouillies pendant six heures pour les stériliser et les rendre plus souples. Le papier recyclé est également bouilli. Les déjections sont mélangées ensuite avec le papier recyclé (dans un rapport de 1:1), puis le tout est pilé dans un mortier. On fabrique le liant en additionnant 15-20 litres d’eau et 300 ml de colle à bois. La quantité de liant ajoutée à la pâte à papier joue sur l’épaisseur du produit final : plus on additionne du liant, plus le papier est épais. La préparation est ensuite posée sur un cadre grillagé afin de permettre à l’eau d’égoutter. La monture est enlevée délicatement pour ne pas abîmer les bords et le grillage est retourné pour poser le papier sur la planche de travail. On enlève avec une éponge les derniers excès d’eau puis on laisse sécher le papier. Avec le papier, on fabrique les produits suivants : des feuilles format A4, des cadres photos, des albums photos, des cahiers de notes, des cartes postales avec enveloppes et des marques pages. La plupart de ces objets sont disponibles en petit et en grand format. En ce qui concerne la fabrication du papier de différentes couleurs, pour le moment les résultats sont encore médiocres. À cette date, on obtient des couleurs différentes en variant les proportions lors du mélange des déjections avec la couleur du papier recyclé. Certains produits sont décorés avec un simple pochoir. Nous pouvons réaliser tout type de produits à la carte. Sachez que lorsque vous achetez ces articles vous contribuez à la sauvegarde des éléphants, à la protection des forêts tout en apportant des ressources financières aux populations soucieuses de protéger leur patrimoine naturel. Les frais d’expédition sont en plus, ils comprennent l’emballage, la manutention et les frais de port. Pour toutes informations complémentaires : contact@sensolidaire.org`,
      country: 'Kenya',
...
// ── Médias — éco-école ─────────────────────────────────────
  ...
  await prisma.partner.createMany({
    data: [
      { name: "AFD", logo_url: "/images/logo-partners/afd.png", display_order: 1 },
      ...
      { name: "Ville de Nice", logo_url: "/images/logo-partners/ville-nice.png", display_order: 18 },
    ]
  })
