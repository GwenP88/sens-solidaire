...
const seed = async () => {
  ...
  const sriLankaData = {
    ...
    health_info: "<ul><li>Vaccins obligatoires à jour : hépatite A et B, typhoïde, rage.</li><li>Pas de risque paludéen majeur à Kegalle. Prévoir protection contre les moustiques.</li><li>Un certificat médical d'aptitude sera demandé avant le départ.</li><li>Bonne condition physique recommandée.</li></ul>",
    helloasso_url: "https://www.helloasso.com/associations/sens-solidaires",
