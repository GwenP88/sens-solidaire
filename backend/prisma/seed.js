...
const MEDIA_POSTS = [
  ...
  // ── Événements ──
  {
    ...
    content: 'Stand d\'information sur les métiers d\'administrateur, chef de projet et logisticien à Annemasse, Grand Genève. Une occasion de présenter les missions de volontariat et les opportunités d\'engagement avec Sens Solidaire.',
    theme: 'Événement',
    date: new Date('2023-01-01'),
    image_url: '/images/hero_missions.jpg',
    external_url: null,
  ...
  },
  {
    ...
    content: 'Partage de l\'expérience de l\'association lors d\'une table ronde sur la gestion de projets multi acteurs éducatifs. Présentation d\'outils utilisés lors de nos animations auprès des acteurs éducatifs de la région PACA.',
    theme: 'Événement',
    date: new Date('2023-01-01'),
    image_url: '/images/hero_missions.jpg',
    external_url: null,
